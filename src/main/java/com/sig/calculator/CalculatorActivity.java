...
public class CalculatorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 查找控件
        GridView mGridButtons = (GridView) findViewById(R.id.grid_buttons);
        mEditInput = (EditText) findViewById(R.id.edit_input);

        // 新建adpater对象，并给GridView设置适配器
        BaseAdapter mAdapter = new CalculatorAdapter(this, mTextBtns);
    ...
    private void setText() {
        ...
        // 添加颜色标签
        mEditInput.setText(Html.fromHtml(tags[0] + mPreStr + tags[2] + tags[1] + mLastStr + tags[2]));
